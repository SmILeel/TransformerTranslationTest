...
if __name__ == '__main__':
    """
    中: 一条狗在公园里玩耍。
    德: Ein hund spielt im park.
    英: A dog is playing in the park.
    
    中: 一群女孩在桥下玩水。
    德: Ein paar mädchen spielten unter der brücke.
    英: A group of girls are playing under the bridge.
    
    中: 一名工程学科的博士研究生正在找工作。
    德: Ein doktor in ingenieurwesen sucht einen job.
    英: A PhD candidate in engineering is looking for a job.
    """

    # srcs = ["Ein hund spielt im park.",
    #         "Ein paar mädchen spielten unter der brücke.",
    #         "in doktor in ingenieurwesen sucht einen job."]
    # tgts = ["A dog is playing in the park.",
    #         "A group of girls are playing under the bridge.",
    #         "A PhD candidate in engineering is looking for a job."]
